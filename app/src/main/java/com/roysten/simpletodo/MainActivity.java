package com.roysten.simpletodo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (resultCode == RESULT_OK && requestCode == EDIT_TEXT_CODE) {
            ...
            if (itemText == "") {
                Toast.makeText(getApplicationContext(), "Empty ToDo item Removed!", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(getApplicationContext(), "ToDo item updated succesfully!", Toast.LENGTH_SHORT).show();
            }
